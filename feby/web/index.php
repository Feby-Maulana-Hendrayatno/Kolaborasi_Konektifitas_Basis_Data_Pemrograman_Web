    ...
    <section class="categories">
        <div class="container">
            ...
            <div class="box-3 float-container">
                <img src="images/nasi kucing.jpg" alt="nasi kucing" class="img-responsive img-curve">
                <h3 class="float-text text-white">nasi kucing</h3>
            </div>
            </a>
            <a href="#">
            <a href="category-foods.php">
            <div class="box-3 float-container">
                <img src="images/sate & gorengan.jpg" alt="sate & gorengan" class="img-responsive img-curve">
                <h3 class="float-text text-white">sate & gorengan</h3>
            </div>
            </a>
            <a href="#">
            <div class="box-3 float-container">
                <img src="images/susu jahe.jpg" alt="susu jahe" class="img-responsive img-curve">
                <h3 class="float-text text-white">susu jahe</h3>
            </div>
            </a>
            <div class="clearfix"></div>
        </div>
