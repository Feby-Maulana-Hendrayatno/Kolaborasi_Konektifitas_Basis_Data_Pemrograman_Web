...
<body>
    <div id="card">
        <div id="card-content">
            ...
            <form method="POST" class="form">
                ...
                <input class="form-content" type="text" name="email_pelanggan" />
    ...
    if (isset($_POST["btn-login"])) {
        ...
        $result = $koneksi->query("SELECT * FROM pelanggan WHERE email_pelanggan = '$email_pelanggan'");

        if (mysqli_num_rows($result) === 1) {
            $data = mysqli_fetch_assoc($result);
            if (password_verify($password_pelanggan, $data['password_pelanggan'])) {
                ...
                if (!isset($_SESSION['keranjang']) OR !empty($_SESSION['keranjang'])) {
                    ...
                    echo "<script>window.location.replace('riwayat.php');</script>";
                }
            } else {
